...
func TestIntegrationMetricsObserveAndRender(t *testing.T) {
	...
	metrics.observe(outcomeSuccess, string(channelTicket), eventTypeAlert, 170*time.Millisecond)
	...
	assertContains(t, rendered, "integration_dispatch_events_total{outcome=\"success\",channel=\"ticket\",event_type=\"alert\"} 1")
